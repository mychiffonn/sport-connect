...
[Everything went pretty straightforward in terms of developing next steps and clearly dividing the work between all group members.]

### 2. What were some challenges your group faced in this unit?

[Neither of us has really interacted with GitHub's project board, so it took a little while to get familiarized with the UI]

### Did you finish all of your tasks in your sprint plan for this week? If you did not finish all of the planned tasks, how would you prioritize the remaining tasks on your list?

[At the time of this commit, we have yet to finish the sprint plan/issues for the week. However, we clearly defined every group member's job, and will most likely be done with most sprints.]

### Which features and user stories would you consider “at risk”? How will you change your plan if those items remain “at risk”?

[Most likely the API that we'll use for displaying an interactive map. This has the chance to fail, in which case we will display a dropdown list for the locations instead.]

### 5. What additional support will you need in upcoming units as you continue to work on your final project?

[Nothing much more different than last week]
